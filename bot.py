...
auth = tweepy.OAuthHandler(S3Connection(os.environ['CONSUMER_KEY'], os.environ['CONSUMER_SECRET_KEY']))
auth.set_access_token(S3Connection(os.environ['ACCESS_TOKEN'], os.environ['ACCESS_SECRET_TOKEN']))
